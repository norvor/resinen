                ...
                <div class="links-list">
                    {#each links as link, i}
                        <div class="link-row">
                            ...
                            <div class="actions">
                                <a href={link.url} target="_blank" class="visit-btn">↗</a>
...
<style>
    ...
    .modal-window { width: 500px; max-width: 90%; background: #0f172a; border: 1px solid #334155; border-radius: 12px; box-shadow: 0 20px 50px rgba(0,0,0,0.5); overflow: hidden; animation: slide 0.3s cubic-bezier(0.16, 1, 0.3, 1); display: flex; flex-direction: column; }
    ...
    .section-label { font-family: 'JetBrains Mono'; font-size: 0.7rem; color: #94a3b8; letter-spacing: 1px; margin-bottom: 10px; }
    
    .links-list { max-height: 300px; overflow-y: auto; margin-bottom: 20px; display: flex; flex-direction: column; gap: 8px; }
    ...
    .l-url { font-family: 'JetBrains Mono'; font-size: 0.7rem; color: #64748b; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 250px; }
    ...
    .empty-state { text-align: center; padding: 20px; color: #475569; font-family: 'JetBrains Mono'; border: 2px dashed #334155; border-radius: 6px; }

    .add-section { display: flex; gap: 10px; background: rgba(0,0,0,0.2); padding: 15px; border-radius: 8px; border: 1px solid #334155; }
    ...
    .modal-footer { padding: 20px; border-top: 1px solid #334155; text-align: right; }
