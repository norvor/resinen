<script lang="ts">
    ...
    function draw() {
        ...
        if (gameOver) {
            ...
            ctx.fillText("Press SPACE to Reboot", canvas.width/2, canvas.height/2 + 40);
        }
    }
    ...
    function handleInputUp(e: KeyboardEvent) {
...
<div class="game-container">
    ...
    <div class="game-ui">
        ...
        <div class="controls-hint">SPACE TO JUMP • DOWN TO DUCK</div>
    </div>
</div>
