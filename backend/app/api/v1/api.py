...
from app.api.v1.endpoints import communities, auth, chapters, academic, referral, social, content
...
api_router.include_router(content.router, prefix="/content", tags=["content"]) # <--- ADD THIS
